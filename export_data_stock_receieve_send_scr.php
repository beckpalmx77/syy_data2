...
// ==========================================================================================
// *** 2. Define Screen ID (ตั้งชื่อ ID ของหน้านี้สำหรับระบบ Preset) ***
$current_screen_id = "stock_5_status";
// ==========================================================================================

// 3. Fetch Master Data from SQL Server
// ดึงข้อมูล Master Data มาแสดงใน Checkbox
...
<head>
    <meta charset="UTF-8">
    <title>Stock 5 Status Report</title>
    <style>
        ...
        <div id="content">
            ...
            <div class="container-fluid" id="container-wrapper">
                <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    <h1 class="h3 mb-0 text-gray-800"><?php echo urldecode($_GET['s'] ?? 'Stock 5 Status (คงเหลือ/สั่งซื้อ/รับเข้า/จอง/ส่ง)') ?></h1>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo $_SESSION['dashboard_page'] ?>">Home</a>
                        </li>
                        <li class="breadcrumb-item"><?php echo urldecode($_GET['m'] ?? 'Report') ?></li>
                        <li class="breadcrumb-item active"
                            aria-current="page"><?php echo urldecode($_GET['s'] ?? 'Stock 5 Status') ?></li>
                    </ol>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card mb-4">
                            <div class="card-body">
                                    ...
                                    <div class="row align-items-end">
                                        ...
                                        <div class="col-md-4 mb-2 text-right">
                                            ...
                                            <button type="submit" form="exportForm" class="btn btn-info mr-1"
                                                    formaction="export_process/print_stock_pdf"
                                                    formtarget="_blank">
                                ...
                                <form method="post" id="exportForm" action="export_process/export_data_stock_receive_send.php">
...
<script>
    $(document).ready(function() {
        ...
        // bindSelectAll('check_all_wl', 'chk-wl'); // หน้า Stock 5 สถานะไม่ได้ใช้ Location ถ้าจะใช้ก็เปิด Comment นี้


        // =======================================================
        // *** ส่วนจัดการ PRESET (Logic ตามต้นฉบับ) ***
        // =======================================================
        function loadPreset(preset_id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Trigger change to update Select All checkbox state
