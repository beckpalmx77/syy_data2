...
!function (e) {
    ...
    function d(t, s) {
        ...
        if (i && i.versionCheck && i.versionCheck("1.10.0")) return t = new i.Api(t), this.classes = A.extend(!0, {}, d.classes), this.c = A.extend(!0, {}, d.defaults, s), s && s.left !== F || this.c.leftColumns === F || (this.c.left = this.c.leftColumns), s && s.right !== F || this.c.rightColumns === F || (this.c.right = this.c.rightColumns), this.s = {
            ...
            leftTopBlocker: A("<div>").css(s).css({left: 0, top: 0}).addClass(this.classes.leftTopBlocker),
            rightBottomBlocker: A("<div>").css(s).css("right", 0).addClass(this.classes.rightBottomBlocker),
            rightTopBlocker: A("<div>").css(s).css({right: 0, top: 0}).addClass(this.classes.rightTopBlocker)
    ...
    return d.prototype.left = function (t) {
        ...
        for (var t = null, s = this.s.dt.column(0).header(), e = null, i = (null !== s && (e = (s = A(s)).outerHeight() + 1, t = A(s.closest("div.dataTables_scroll")).css("position", "relative")), this.s.dt.column(0).footer()), l = null, o = (null !== i && (l = (i = A(i)).outerHeight(), null === t) && (t = A(i.closest("div.dataTables_scroll")).css("position", "relative")), this.s.dt.columns().data().toArray().length), r = 0, d = 0, h = A(this.s.dt.table().node()).children("tbody").children("tr"), n = 0, a = new Map, c = 0; c < o; c++) {
            ...
            if (0 < c && a.set(c - 1, n), f.visible()) {
                var u = A(f.header()), g = A(f.footer());
                if (c - n < this.c.left) {
                    if (A(this.s.dt.table().node()).addClass(this.classes.tableFixedLeft), t.addClass(this.classes.tableFixedLeft), 0 < c - n) for (var C = c; C + 1 < o;) {
                        if ((y = this.s.dt.column(C - 1, {page: "current"})).visible()) {
        ...
        for (var B = 0, S = 0, _ = 0, c = o - 1; 0 <= c; c--) if ((f = this.s.dt.column(c)).visible()) {
            var u = A(f.header()), g = A(f.footer()), k = a.get(c);
            if (k === F && (k = n), c + _ >= o - this.c.right) {
                if (A(this.s.dt.table().node()).addClass(this.classes.tableFixedRight), t.addClass(this.classes.tableFixedRight), c + 1 + _ < o) for (var y, C = c; C + 1 < o;) {
                    if ((y = this.s.dt.column(C + 1, {page: "current"})).visible()) {
        ...
        this.s.dt.on("key-focus", function (t, s, e) {
            var i, l, o, r = A(e.node()).offset(), d = A(A(h.s.dt.table().node()).closest("div.dataTables_scrollBody"));
