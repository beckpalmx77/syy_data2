...
if (strlen($_SESSION['alogin']) == "") {
    ...
    ORDER BY BNKAC_KEY ";
    $stmt_bank = $conn_sqlsvr->prepare($sql_bank);
    $stmt_bank->execute();
    $BankRecords = $stmt_bank->fetchAll();
                                                        ...
                                                        <form id="from_data" method="post"
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <label for="BANK">เลือก ธนาคาร :</label>
                                                                    <select name="BANK" id="BANK"
                                                                            class="form-control" required>
                                                                        <option value="-">-</option>
                                                                        <?php foreach ($BankRecords as $row) { ?>
                                                                            <option value="<?php echo $row["BNKAC_KEY"]; ?>">
                                                                                <?php echo $row["BNKAC_NAME"]; ?>
                                                                            </option>
                                                                        <?php } ?>
                                                                    </select>
    ...
    <script>
        $(document).ready(function () {
            ...
            let doc_date_to = getDay2Digits(today) + "-" + getMonth2Digits(today) + "-" + today.getFullYear();
            $('#doc_date_start').val(doc_date_start);
            $('#doc_date_to').val(doc_date_to);
        });
    </script>
