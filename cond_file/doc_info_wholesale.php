...
AND (DOCTYPE.DT_DOCCODE = 'IV00' OR DOCTYPE.DT_DOCCODE = 'DS00' OR DOCTYPE.DT_DOCCODE = 'CV00' OR DOCTYPE.DT_DOCCODE = 'CS00' OR DOCTYPE.DT_DOCCODE = 'IS' OR DOCTYPE.DT_DOCCODE = 'ISO' OR DOCTYPE.DT_DOCCODE LIKE 'IS%' OR DOCTYPE.DT_DOCCODE LIKE 'ISO%')";

$sql_order_sale = " ORDER BY DOCINFO.DI_DATE DESC, FORMAT(cast(DOCINFO.DI_CRE_DATE as datetime),'HH:mm') DESC, DOCINFO.DI_REF ";