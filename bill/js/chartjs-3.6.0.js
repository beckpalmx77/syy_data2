...
!function (t, e) {
    ...
    function zi(t, e, i) {
        ...
        const {property: s, start: n, end: o} = i,
            a = e.length, {compare: r, between: l, normalize: h} = Ei(s), {start: c, end: d, loop: u, style: f} = function (t, e, i) {
    ...
    function Ln(t, e, i, s, n) {
        ...
        const g = (f - Math.max(.001, f * c - i / bt) / c) / 2, p = r + g + u,
            m = n - g - u, {outerStart: x, outerEnd: b, innerStart: _, innerEnd: y} = An(e, d, c, m - p), v = c - x,
    ...
    class wo extends Ms {
        ...
        fit() {
            ...
            const i = t.labels, s = Ve(i.font), n = s.size,
                o = this._computeTitleHeight(), {boxWidth: a, itemHeight: r} = vo(i, n);
            let l, h;
    ...
    function Io(t, e, i, s) {
        const {caretSize: n, caretPadding: o, cornerRadius: a} = t, {xAlign: r, yAlign: l} = i,
            h = n + o, {topLeft: c, topRight: d, bottomLeft: u, bottomRight: f} = Fe(a);
        let g = function (t, e) {
            let {x: i, width: s} = t;
    ...
    class Vo extends Ms {
        ...
        getCaretPosition(t, e, i) {
            const {xAlign: s, yAlign: n} = this, {caretSize: o, cornerRadius: a} = i, {topLeft: r, topRight: l, bottomLeft: h, bottomRight: c} = Fe(a), {x: d, y: u} = t, {width: f, height: g} = e;
            let p, m, x, b, _, y;
            ...
            if (e.pointLabels.display && function (t, e) {
                ...
                for (let n = e - 1; n >= 0; n--) {
                    const e = s.setContext(t.getPointLabelContext(n)),
                        o = Ve(e.font), {x: a, y: r, textAlign: l, left: h, top: c, right: d, bottom: u} = t._pointLabelItems[n], {backdropColor: f} = e;
                    if (!$(f)) {
                        const t = Be(e.backdropPadding);
